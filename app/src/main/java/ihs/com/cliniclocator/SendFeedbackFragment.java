...
public class SendFeedbackFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Typeface tf = Typeface.createFromAsset(rootView.getContext().getAssets(), "fonts/RobotoCondensed-Light.ttf");

        TextView textViewTo = (TextView) rootView.findViewById(R.id.textViewTo);
        textViewTo.setTypeface(tf);

        final TextView textViewToEmail = (TextView) rootView.findViewById(R.id.textViewToEmail);
        textViewToEmail.setTypeface(tf);

        TextView textViewSubject = (TextView) rootView.findViewById(R.id.textViewSubject);
        textViewSubject.setTypeface(tf);

        final EditText editTextSubject = (EditText) rootView.findViewById(R.id.editTextSubject);
        ...
        final EditText editTextMessage = (EditText) rootView.findViewById(R.id.editTextMessage);
